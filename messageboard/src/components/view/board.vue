...
<div>
  ...
  <li><router-link to="/register" tag="a">Regist</router-link></li>
  ...
  <div class="board">
    <div class="userMsg">
      <div class="warp">
        <div class="user_img">
          <img src="../../assets/img/default_head.png"/>
        </div>
        <div class="user_msg">
    ...
    <div class="board_panel">
      ...
      <div class="out">
       ...
       <div class="input">
          ...
          <em class="titleWar">别忘了标题</em>
          <textarea id="comment" placeholder="在这里写下你的留言吧~" minlength="1" @blur="commentBlur" @focus="commentFocus"></textarea>
...
ul {
  ...
  padding: 0;
  overflow: hidden;
  background-color: rgb(212, 217, 240);
}
